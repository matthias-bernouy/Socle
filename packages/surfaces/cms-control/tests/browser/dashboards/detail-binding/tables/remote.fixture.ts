...
export async function installRemoteTables(page: Page, bundle: string, styles: string) {
    const fixture = await installReadonlyRoutes(page, bundle, styles, {
        resource: {
            title: "Shared table options",
            category: "tennis",
            rows: [
                { id: "first", label: "First", brand: "brand-0", supplier: "supplier-0" },
                { id: "second", label: "Second", brand: "brand-1", supplier: "supplier-1" },
            ],
        },
        fields: [
            {
            ...
            },
            {
                ...
                editable: true,
                columns: [
                    { id: "label", path: "label", label: "Label", editable: true },
